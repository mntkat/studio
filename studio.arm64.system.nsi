...
OutFile "bin\Sunaba.Studio.Setup.arm64.System.exe"
...
${If} ${RunningX64}
  ...
  File "bin\windows-arm64-release\Sunaba.Studio.exe"
  ...
  File "bin\windows-arm64-release\sunaba.windows.template_release.arm64.dll"
  File "bin\windows-arm64-release\libdd3d.windows.template_release.arm64.enabled.dll"
  File "Studio\project.ico" 
  SetOutPath "$INSTDIR\data_Sunaba.Studio_windows_arm64"
  SetOverwrite try
  File /r "bin\windows-arm64-release\data_Sunaba.Studio_windows_arm64\*.*"
...
Section Uninstall
  ...
  Delete "$INSTDIR\libdd3d.windows.template_release.arm64.enabled.dll"
  Delete "$INSTDIR\sunaba.windows.template_release.arm64.dll"
